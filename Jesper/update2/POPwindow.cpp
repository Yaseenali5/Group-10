...
{
  if (pop == "PCB") {
    safetyLvl->setToolTip("compliant under 0.1 ug/l\nwarning when inbetween 0.1 and 0.5 ug/l\nnon-compliant when over 0.5 ug/l");
  } else if (pop == "DDT") {
    safetyLvl->setToolTip("compliant under 0.1 ug/l\nwarning when inbetween 0.1 and 0.5 ug/l\nnon-compliant when over 0.5 ug/l");
  } else {
    safetyLvl->setToolTip("compliant under 0.03 ug/l\nwarning when inbetween 0.03 and 0.1 ug/l\nnon-compliant when over 0.1 ug/l");
  }
}