...
void RawWindow::addPageMenu()
{
  ...
  QAction *page1Action = pageMenu->addAction("Pollutant Overview");
  QAction *page2Action = pageMenu->addAction("Persistent Organic Pollutants (POPs)");
  QAction *page3Action = pageMenu->addAction("Environmental Litter Indicators");
  QAction *page4Action = pageMenu->addAction("Fluorinated Compounds");
  QAction *page5Action = pageMenu->addAction("Compliance Dashboard");
  QAction *page6Action = pageMenu->addAction("Raw Data");
