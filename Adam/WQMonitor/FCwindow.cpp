...
{    
    resultLabel = new QLabel("Choose PFAS:");
    resultBox = new QComboBox(this);
    
    loadGButton = new QPushButton("Load Graph");
    healthInfo = new QPushButton("Health Information");
    envInfo = new QPushButton("Environmental Information");
...
void FCWindow::checkItemCt()
{
    ...
    if (resultBox->count() == 0) {
        QLabel *msg = new QLabel("Location doesn't have Fluorinated Compounds\nPlease select another location");
